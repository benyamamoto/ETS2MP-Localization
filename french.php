...
$_lang["settings.saved.with.mail"] = "Le compte a été sauvegardé. Vérifiez vos e-mails et activez à nouveau votre compte.";
$_lang["new.email.in.use"] = "Cette adresse mail est déjà utilisée.";
...
$_lang["your.mail"] = "Votre mail";
$_lang["content"] = "Contenu";
$_lang["send"] = "Envoyer";
$_lang["contact.message.sent"] = "Merci de nous contacter. Veuillez attendre notre réponse.";
$_lang["topic"] = "Sujet";
$_lang["contact.message.too.short"] = "Le message est trop court. Il faut au minimum 10 caractères.";
$_lang["contact.topic.too.short"] = "Le sujet est trop court. Il faut au minimum 10 caractères.";
$_lang["invalid.mail.forgot.password"] = "Impossible de trouver un compte avec cette adresse mail.";
